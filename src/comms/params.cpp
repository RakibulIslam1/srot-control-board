...
static const Desc SCALARS[] = {
    ...
    { "ATC_RAT_PIT_IMAX", "atc_pit_imax", &g_params.rat_pit_imax,   0.444f },
    ...
    { "ATC_RAT_YAW_IMAX", "atc_yaw_imax", &g_params.rat_yaw_imax,   0.222f },
    ...
    // M1 and M8 are reversed on the airframe as built -- measured on the bench and
    // confirmed by the operator's Motor Test pass, so this is the as-flown default
    // rather than something a fresh board should have to be told again.
    ...
    // Joystick map as actually flown, read back off the board 2026-08-07. The old
    // defaults were a guess at a generic layout and matched no real controller.
    { "BTN0_FUNCTION",  "BTN0_FUNCTION",  &g_params.btn_func[0],  0.0f  },
    { "BTN1_FUNCTION",  "BTN1_FUNCTION",  &g_params.btn_func[1],  5.0f  },
    { "BTN2_FUNCTION",  "BTN2_FUNCTION",  &g_params.btn_func[2],  6.0f  },
    { "BTN3_FUNCTION",  "BTN3_FUNCTION",  &g_params.btn_func[3],  7.0f  },
    { "BTN4_FUNCTION",  "BTN4_FUNCTION",  &g_params.btn_func[4],  0.0f  },
    { "BTN5_FUNCTION",  "BTN5_FUNCTION",  &g_params.btn_func[5],  0.0f  },
    { "BTN6_FUNCTION",  "BTN6_FUNCTION",  &g_params.btn_func[6],  0.0f  },
    { "BTN7_FUNCTION",  "BTN7_FUNCTION",  &g_params.btn_func[7],  0.0f  },
    { "BTN8_FUNCTION",  "BTN8_FUNCTION",  &g_params.btn_func[8],  4.0f  },
    { "BTN9_FUNCTION",  "BTN9_FUNCTION",  &g_params.btn_func[9],  2.0f  },
    { "BTN10_FUNCTION", "BTN10_FUNCTION", &g_params.btn_func[10], 0.0f  },
    { "BTN11_FUNCTION", "BTN11_FUNCTION", &g_params.btn_func[11], 0.0f  },
    { "BTN12_FUNCTION", "BTN12_FUNCTION", &g_params.btn_func[12], 42.0f },
    { "BTN13_FUNCTION", "BTN13_FUNCTION", &g_params.btn_func[13], 43.0f },
